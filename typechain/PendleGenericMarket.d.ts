...
interface PendleGenericMarketInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleGenericMarket extends Contract {
  ...
  interface: PendleGenericMarketInterface;
