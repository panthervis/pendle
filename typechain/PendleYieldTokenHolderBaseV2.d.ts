...
interface PendleYieldTokenHolderBaseV2Interface extends ethers.utils.Interface {
  functions: {
...
export class PendleYieldTokenHolderBaseV2 extends Contract {
  ...
  interface: PendleYieldTokenHolderBaseV2Interface;
  ...
  setUpEmergencyMode(arg0: string, overrides?: CallOverrides): Promise<void>;
