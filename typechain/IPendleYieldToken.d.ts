...
interface IPendleYieldTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IPendleYieldToken extends Contract {
  ...
  interface: IPendleYieldTokenInterface;
