...
interface PendleSLPLiquidityMiningInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleSLPLiquidityMining extends Contract {
  ...
  interface: PendleSLPLiquidityMiningInterface;
