...
interface PendleFutureYieldTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleFutureYieldToken extends Contract {
  ...
  interface: PendleFutureYieldTokenInterface;
  ...
  callStatic: {
    ...
    approveRouter(user: string, overrides?: CallOverrides): Promise<void>;
