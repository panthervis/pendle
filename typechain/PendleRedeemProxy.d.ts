...
interface PendleRedeemProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleRedeemProxy extends Contract {
  ...
  interface: PendleRedeemProxyInterface;
