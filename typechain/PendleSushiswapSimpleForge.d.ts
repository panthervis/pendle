...
interface PendleSushiswapSimpleForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleSushiswapSimpleForge extends Contract {
  ...
  interface: PendleSushiswapSimpleForgeInterface;
