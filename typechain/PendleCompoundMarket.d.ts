...
interface PendleCompoundMarketInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleCompoundMarket extends Contract {
  ...
  interface: PendleCompoundMarketInterface;
