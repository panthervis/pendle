...
interface MockPendleGovernanceManagerInterface extends ethers.utils.Interface {
  functions: {
    "claimGovernance()": FunctionFragment;
    "governance()": FunctionFragment;
    "pendingGovernance()": FunctionFragment;
    "stub()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "stub", values?: undefined): string;
  encodeFunctionData(
...
export class MockPendleGovernanceManager extends Contract {
  ...
  interface: MockPendleGovernanceManagerInterface;
  ...
  callStatic: {
    ...
    stub(overrides?: CallOverrides): Promise<void>;
