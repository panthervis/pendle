...
interface MockPendleLpHolderInterface extends ethers.utils.Interface {
  functions: {
...
export class MockPendleLpHolder extends Contract {
  ...
  interface: MockPendleLpHolderInterface;
