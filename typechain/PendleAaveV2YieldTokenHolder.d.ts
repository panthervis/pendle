...
interface PendleAaveV2YieldTokenHolderInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleAaveV2YieldTokenHolder extends Contract {
  ...
  interface: PendleAaveV2YieldTokenHolderInterface;
