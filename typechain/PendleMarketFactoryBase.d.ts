...
interface PendleMarketFactoryBaseInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleMarketFactoryBase extends Contract {
  ...
  interface: PendleMarketFactoryBaseInterface;
