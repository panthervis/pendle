...
interface IPendleMarketFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IPendleMarketFactory extends Contract {
  ...
  interface: IPendleMarketFactoryInterface;
