...
interface TimelockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "adminInitialized()": FunctionFragment;
...
export class Timelock extends Contract {
  ...
  functions: {
    ...
    adminInitialized(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    adminInitialized(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    adminInitialized(overrides?: CallOverrides): Promise<PopulatedTransaction>;
