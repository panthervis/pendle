...
interface PendleGenericLiquidityMiningInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleGenericLiquidityMining extends Contract {
  ...
  interface: PendleGenericLiquidityMiningInterface;
