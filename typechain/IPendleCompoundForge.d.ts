...
interface IPendleCompoundForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class IPendleCompoundForge extends Contract {
  ...
  interface: IPendleCompoundForgeInterface;
