...
interface PendleAaveV2ForgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lastNormalisedIncomeForForgeFee(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lastNormalisedIncomeForForgeFee",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class PendleAaveV2Forge extends Contract {
  ...
  interface: PendleAaveV2ForgeInterface;
  ...
  functions: {
    ...
    lastNormalisedIncomeForForgeFee(
      arg0: string,
      arg1: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    "lastNormalisedIncomeForForgeFee(address,uint256)"(
      arg0: string,
      arg1: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
