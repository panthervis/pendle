...
interface PendleSushiswapComplexForgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lastRateForUnderlyingAsset(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lastRateForUnderlyingAsset",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class PendleSushiswapComplexForge extends Contract {
  ...
  interface: PendleSushiswapComplexForgeInterface;
  ...
  functions: {
    ...
    getYieldBearingToken(
      _underlyingAsset: string,
      overrides?: CallOverrides
    ): Promise<[string] & { yieldBearingToken: string }>;
    ...
    lastRateForUnderlyingAsset(
      arg0: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    "lastRateForUnderlyingAsset(address)"(
      arg0: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
