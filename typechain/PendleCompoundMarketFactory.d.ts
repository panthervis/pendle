...
interface PendleCompoundMarketFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleCompoundMarketFactory extends Contract {
  ...
  interface: PendleCompoundMarketFactoryInterface;
