...
interface PendleCompoundV2ForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleCompoundV2Forge extends Contract {
  ...
  interface: PendleCompoundV2ForgeInterface;
  ...
  functions: {
    ...
    getYieldBearingToken(
      _underlyingAsset: string,
      overrides?: CallOverrides
    ): Promise<[string] & { cTokenAddr: string }>;
