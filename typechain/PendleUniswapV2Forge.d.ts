...
interface PendleUniswapV2ForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class PendleUniswapV2Forge extends Contract {
  ...
  interface: PendleUniswapV2ForgeInterface;
