...
interface PendleCompoundForgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialRate(address)": FunctionFragment;
    ...
    "registerCTokens(address[],address[])": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "initialRate", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "registerCTokens",
  ...
  events: {
    ...
    "RegisterCTokens(address[],address[])": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RegisterCTokens"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TokenWithdraw"): EventFragment;
}

export class PendleCompoundForge extends Contract {
  ...
  interface: PendleCompoundForgeInterface;
  ...
  functions: {
    ...
    initialRate(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    "lastRate(address,uint256,address)"(
      arg0: string,
      arg1: BigNumberish,
      arg2: string,
      overrides?: CallOverrides
    ...
    "lastRateBeforeExpiry(address,uint256)"(
      arg0: string,
      arg1: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    "registerCTokens(address[],address[])"(
      _underlyingAssets: string[],
      _cTokens: string[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    RegisterCTokens(
      ...
      [string[], string[]],
      { underlyingAssets: string[]; cTokens: string[] }
    >;
