...
import type { PendleMarketBase } from "../PendleMarketBase";

export class PendleMarketBase__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PendleMarketBase {
    return new Contract(address, _abi, signerOrProvider) as PendleMarketBase;
  }
}
