...
import type { PendleForgeBaseV2 } from "../PendleForgeBaseV2";

export class PendleForgeBaseV2__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PendleForgeBaseV2 {
    return new Contract(address, _abi, signerOrProvider) as PendleForgeBaseV2;
  }
}
