...
import type { PendleForgeBase } from "../PendleForgeBase";

export class PendleForgeBase__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PendleForgeBase {
    return new Contract(address, _abi, signerOrProvider) as PendleForgeBase;
  }
}
