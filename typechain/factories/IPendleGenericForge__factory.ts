...
import type { IPendleGenericForge } from "../IPendleGenericForge";

export class IPendleGenericForge__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPendleGenericForge {
    return new Contract(address, _abi, signerOrProvider) as IPendleGenericForge;
  }
}
