...
import type { IPendleAaveForge } from "../IPendleAaveForge";

export class IPendleAaveForge__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPendleAaveForge {
    return new Contract(address, _abi, signerOrProvider) as IPendleAaveForge;
  }
}
